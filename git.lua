...
local git_parser = parser(
    {
        ...
        "co" .. parser({checkout_spec_generator},  -- alias to git checkout
            "-q", "--quiet",
            "-b",
            "-B",
            "-l",
        ...
        "cane" .. parser(  -- alias to git commit --amend --no-edit
            "-a", "--all",
            "-p", "--patch",
            "-C", "--reuse-message=",
            "-c", "--reedit-message=",
            ...
            "--cleanup", -- .. parser({"strip", "whitespace", "verbatim", "default"}),
            "-e", "--edit",
            -- "--no-edit", (already part of alias)
            -- "--amend", (already part of alias)
            "--no-post-rewrite",
            "-i", "--include",
            "-o", "--only",
            "-u", "--untracked-files", "--untracked-files=", -- .. parser({"no", "normal", "all"}),
        ...
        "d" .. parser({local_or_remote_branches, matchers.files}),  -- alias to git diff
        "diff-files",
        "diff-index",
        "diff-tree",
        "difftool"..parser(
